...
async function main() {
  ...
  const receipt = {
    ...
    browser: { engine: `chromium (Playwright ${JSON.parse(readFileSync(new URL('../node_modules/@playwright/test/package.json', import.meta.url))).version} bundled), headless`, version: browserVersion, ...env },
